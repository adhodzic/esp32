...
//byte myAddress = ELECHOUSE_cc1101.SpiReadStatus(CC1101_ADDR);
//transmitt_byte[1] = myAddress;
//Serial.print(transmitt_byte[1]);
//ELECHOUSE_cc1101.SendData(transmitt_byte, 9, 1);
