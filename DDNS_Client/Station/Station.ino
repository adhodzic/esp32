...
#ifdef ESP32
gdo0 = 6;  // for esp32! GDO0 on GPIO pin 2.
#elif ESP8266
gdo0 = 6;  // for esp8266! GDO0 on pin 5 = D1.
#else
gdo0 = 6;  // for Arduino! GDO0 on pin 6.
    ...
    ELECHOUSE_cc1101.setAddr(0x01);            // Address used for packet filtration. Optional broadcast addresses are 0 (0x00) and 255 (0xFF).
...
void loop() {
  float temp = 123;
  Serial.println(temp);
  sprintf(buffer, "%d", round(temp));
  Serial.println((char *)buffer);
  ELECHOUSE_cc1101.SendData(buffer, 16);
  Serial.print("Buffer: ");
  for (int i = 0; i<16; i++){
